...
const FirstPage = () => {
  return (
    <div>
      ...
      <div className="relative bg-[url('https://assets.nflxext.com/ffe/siteui/vlv3/a99688ca-33c3-4099-9baa-07a2e2acb398/ca15fd28-b624-4852-8bfe-9cdd5c88475d/IN-en-20240520-popsignuptwoweeks-perspective_alpha_website_small.jpg')] h-[600px] md:h-[96vh] bg-center ">
